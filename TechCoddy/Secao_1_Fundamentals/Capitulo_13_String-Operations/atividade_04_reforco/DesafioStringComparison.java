public class DesafioStringComparison {
    ...
    public static String checkExactMatch(String stored, String attempt) {
        ...
        boolean comp1 = stored.equals(attempt);
        String result = String.format("Password match (exact): %b", comp1);
    ...
    public static String checkIgnoreCase(String stored, String attempt) {
        ...
        boolean comp1 = stored.equalsIgnoreCase(attempt);
        String result = String.format("Password match (ignore case): %b", comp1);
    ...
    public static String comparePasswords(String stored, String attempt) {
        ...
        int comp1 = attempt.compareTo(stored);
        String position = (comp1 > 0) ? "After" : (comp1 == 0) ? "Exact match" : "Before";
        String result = String.format("Password comparison: %s", position);
